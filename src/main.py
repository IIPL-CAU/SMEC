...
parser.add_argument('--raf_path', type=str, default='/mnt/c/Erasing-Attention-Consistency/RAF', help='raf_dataset_path')
parser.add_argument('--resnet50_path', type=str, default='/mnt/c/Erasing-Attention-Consistency/resnet50_ft_weight.pkl', help='pretrained_backbone_path')
...
parser.add_argument('--save_path', type=str, default='/mnt/c/Erasing-Attention-Consistency', help='weight save path')
...
def train(epoch, args, model, train_loader, optimizer, scheduler, device):
    ...
    for batch_i, (imgs1, labels, indexes, imgs2) in enumerate(train_loader):
        ...
        tiled_images = tile_features(imgs1, args.num_pieces) # (4 * N, 3, H//2, h//2)
        
        output, hm1 = model(imgs1, with_cam=True) # (N, 7), (N, 7, H//16, W//16) 
